...
def main():
    st.header("Chat Bot Interviewer")

    message_placeholder = st.container()
    message_placeholder.markdown('Robot:   ' + "Hi there, Welcome to our Bot Interview Program. Please provide your name")
